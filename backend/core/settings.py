...
CORS_ALLOWED_ORIGINS = config('CORS_ALLOWED_ORIGINS', default='http://16.52.17.116,http://localhost:3000,http://127.0.0.1:3000,http://localhost:3002,http://127.0.0.1:3002,http://appcitas.softex-labs.xyz').split(',')
